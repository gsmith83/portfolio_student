...
<!--
      ...
      Important Notes:
        ...
        1) Notice the use of the include statement
           Note: the use of the start/end php tags in the simple.php file
...
<p> Even though include did not work, the web page continues. Or does it? </p>
