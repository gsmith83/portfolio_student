...
<html>
    <head>
        ...
        <meta type="text/javascript" src="/jquery/jquery-2.1.3.js">
    </head>
    <body>
                ...
                <h2>TA Application</h2>
                    <form action="ta_application_review.php" method="post">
                        ...
                        <div class="question">
                            ...
                            <input type="tel" name="phoneNumberEvening" required/>
                        </div>
                        ...
                        <div class="submitBtn"><input type="submit" id="submit"></div>
                    </form>
        }
                </div>
            <div id="footer">
